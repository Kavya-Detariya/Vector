"""
src/corpus_vocab.py — Templated vocabulary domains for procedural corpus generation.
"""

DOMAINS = {
    "weather": {
        "subject": [
            "A cold front", "Heavy rain", "The morning fog", "A sudden storm",
            "Clear skies", "Strong winds", "A heatwave", "Light snow",
            "Humid air", "A thunderstorm", "The afternoon sun", "A cool breeze",
        ],
        "verb": [
            "is moving across", "settled over", "swept through", "is expected in",
            "lingered above", "rolled into", "developed over", "cleared out of",
            "built up near", "drifted toward",
        ],
        "object": [
            "the coastal region", "downtown", "the valley", "the northern plains",
    ...
    "food": {
        "subject": [
            "The chef", "A local bakery", "The new restaurant", "A street vendor",
            "The pastry cook", "A home cook", "The food critic", "A catering team",
            "The farmers market", "A late-night diner",
        ],
        "verb": [
            "prepared", "served", "experimented with", "perfected", "sold out of",
            "reinvented", "garnished", "slow-cooked", "plated", "grilled",
        ],
        "object": [
            "a spicy noodle dish", "fresh sourdough bread", "a seasonal vegetable stew",
    ...
    "travel": {
        "subject": [
            "A group of tourists", "The tour guide", "A solo backpacker", "The cruise ship",
            "A family on vacation", "The travel agency", "A photographer", "The airline crew",
            "A pair of hikers", "The exchange student",
        ],
        "verb": [
            "explored", "wandered through", "booked a trip to", "photographed",
            "got lost in", "recommended", "flew into", "hiked across", "toured", "camped near",
        ],
        "object": [
            "the old town square", "a remote mountain village", "the coastal cliffs",
    ...
    "technology": {
        "subject": [
            "The startup", "A software engineer", "The research lab", "A new smartphone",
            "The open-source project", "A hardware team", "The cybersecurity firm",
            "An AI model", "The cloud provider", "A robotics company",
        ],
        "verb": [
            "launched", "patched a bug in", "open-sourced", "benchmarked", "redesigned",
            "shipped an update to", "optimized", "deprecated", "scaled up", "reverse-engineered",
        ],
        "object": [
            "a new mobile app", "the authentication system", "a machine learning pipeline",
    ...
    "finance": {
        "subject": [
            "The central bank", "An investment firm", "The stock market", "A startup founder",
            "The regulator", "A hedge fund", "The board of directors", "A retail investor",
            "The credit union", "An economist",
        ],
        "verb": [
            "raised concerns about", "forecasted", "adjusted", "reported", "reviewed",
            "restructured", "invested heavily in", "downgraded", "audited", "hedged against",
        ],
        "object": [
            "quarterly earnings", "interest rate policy", "a merger deal", "market volatility",
    ...
    "health": {
        "subject": [
            "The clinic", "A physical therapist", "The research team", "A marathon runner",
            "The nutritionist", "A new patient", "The hospital staff", "A yoga instructor",
            "The public health department", "A personal trainer",
        ],
        "verb": [
            "recommended", "monitored", "treated", "studied the effects of", "designed a plan for",
            "screened for", "published findings on", "adjusted", "tracked progress on", "advised against",
        ],
        "object": [
            "a sleep routine", "a knee injury", "a balanced diet", "cardiovascular health",
    ...
    "science": {
        "subject": [
            "The astrophysicist", "A field biologist", "The research institute", "A geologist",
            "The lab technician", "A climate scientist", "The genetics team", "An oceanographer",
            "The particle physics group", "A graduate student",
        ],
        "verb": [
            "discovered", "measured", "modeled", "published a study on", "collected samples of",
            "simulated", "observed", "cataloged", "analyzed", "peer-reviewed",
        ],
        "object": [
            "a distant exoplanet", "coral reef degradation", "seismic activity",
    ...
    "home": {
        "subject": [
            "The homeowner", "A contractor", "The interior designer", "A DIY enthusiast",
            "The landscaping crew", "A plumber", "The electrician", "A real estate agent",
            "The renovation team", "A first-time buyer",
        ],
        "verb": [
            "remodeled", "repainted", "rewired", "landscaped", "renovated", "inspected",
            "installed new fixtures in", "refinished", "waterproofed", "insulated",
        ],
        "object": [
            "the kitchen", "the backyard patio", "a small apartment", "the basement",
